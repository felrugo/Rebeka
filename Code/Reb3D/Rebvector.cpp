...
inline void RebVector::Set(float _x, float _y, float _z, float _w) {
   x=_x; y=_y; z=_z; w=_w;
   } 
/*----------------------------------------------------------------*/

inline float RebVector::GetLength(void) {
   float f=0;
...
inline float RebVector::GetSqrLength(void) const {
   return (x*x + y*y + z*z); 
   }
/*----------------------------------------------------------------*/

inline void RebVector::Negate(void) {
   x = -x;  y = -y;  z = -z;
   }
/*----------------------------------------------------------------*/

inline float RebVector::AngleWith(RebVector &v) {
   return (float)acos( ((*this) * v) / (this->GetLength()*v.GetLength()) );
   }
/*----------------------------------------------------------------*/

inline void RebVector::Normalize(void) {
   if (!g_bSSE) {
 ...
 */
inline void RebVector::Difference(const RebVector &v1, const RebVector &v2) {
   x = v2.x - v1.x;
   y = v2.y - v1.y;
   z = v2.z - v1.z;
   w = 1.0f;
 ...
 */
inline void RebVector::Cross(const RebVector &v1, const RebVector &v2) {
   if (!g_bSSE) {
 ...
 */
inline void RebVector::RotateWith(const RebMatrix &m) {
 ...
 */
inline void RebVector::InvRotateWith(const RebMatrix &m) {
