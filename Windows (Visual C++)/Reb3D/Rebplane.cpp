...
inline void RebPlane::Set(const RebVector &vcN, const RebVector &vcP) {
   m_fD      = - ( vcN * vcP);
   m_vcN     = vcN;
   m_vcPoint = vcP;
   }
...
inline void RebPlane::Set(const RebVector &v0, const RebVector &v1, 
                          const RebVector &v2) {
...
inline float RebPlane::Distance(const RebVector &vcPoint) {
...
inline int RebPlane::Classify(const RebVector &vcPoint) {
